          ...
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    ...
                    <form action="upload.php" method="post">
                         <input type="text" name="uname" placeholder="User Name" class="ai"/><br>
                         <input type="password" name="pass" placeholder="password" class="ai"/><br>
                         <input type="submit"   value="login" name="login" class="ab"/>
                    </form>
               </div>
